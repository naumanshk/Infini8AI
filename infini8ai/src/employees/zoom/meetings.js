                            ...
                            return (
                                <tr>
                                    ...
                                    <td><div class="col-md-12 mt-3 ">
                                        <a href={`https://zoom-infini8ai.web.app/join?meetingId=${item.meetingId}&pwd=${item.passcode}&username=${localStorage.getItem('Employee')}`} class="btn btn-success-gradiant text-white btn-md border-0 padding-btn font"><span>Join</span></a>
                                    </div></td>
